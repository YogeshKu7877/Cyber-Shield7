...
const products = [
  {
    name: "Cyber Security",
    description:
      "Discover the significance of digital privacy in the online world.",
    href: "/cyberSecurity",
  },
  {
    name: "Digital Privacy",
    description: "Explore expert tips for safeguarding your online privacy.",
    href: "/digitalPrivacy",
  },
  {
    name: "Privacy risks and threats",
    description:
      "Identify common privacy risks and threats in the digital landscape.",
    href: "/privacyRisk",
  },
  {
    name: "Data security",
    description:
      "Learn best practices for securing your data and personal information.",
    href: "/dataSecurity",
  },
  {
    name: "Hate Speech Detection",
    description: "Effortlessly identify and combat hate speech online.",
    href: "/hsd",
  },
];
const callsToAction = [
  ...
  return (
    <>
      <header className="bg-[#ebf4f5] sticky top-0 z-10">
        <nav
          className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 shadow-lg"
          aria-label="Global"
        >
          <div className="flex lg:flex-1">
            <Link to="/" className="-m-1.5 p-1.5">
              <span className="sr-only">Your Company</span>
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-[#172554]">
                Cyber Shield
              </span>
            </Link>
          </div>
